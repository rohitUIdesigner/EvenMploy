                                        	...
                                        	<div class="col-md-10 offset-md-1">
		                                        ...
		                                        <form>
		                                        	...
		                                        	<div class="form-group">
		                                        		...
		                                        		<textarea class="form-control" rows="5" placeholder="Enter description here..."></textarea>
		                                        	</div>
		                                        	<div class="form-group">
		                                        		<label>Job Dates</label>
		                                        		<input type="date" name="jdates" class="form-control" value="10/09/2019">
		                                        	</div>
		                                        	<div class="form-group">
		                                        		<label>Number Of Freelancers Required</label>
		                                        		<input type="text" name="fnumber" class="form-control" value="10">
		                                        	</div>
		                                        	<div class="form-group">
		                                        	...
		                                        	<div class="form-group">
		                                        		...
		                                        		<input type="text" name="payment" class="form-control" value="$100">
		                                        	</div>
		                                        	<div class="form-group">
