...
<head>
	<meta charset="utf-8">
		...
		<title>EventMPloy- Privacy policy</title>
        <!-- css here -->
...
<body>
	<div class="wrapper">
		...
		<!-- header index -->
		<div class="home-page-wrapper term_cond">
						...
						<div class="card-wrap">
							<div class="row">
								<div class="col-lg-8 offset-lg-2 col-md-6">
									<div class="first-cp">
										<div class="term">
											<p class="first text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
